...
\begin{itemize}
	...
	\item \bibentry{Wang2018} \textbf{Some type of inverse analysis using a machine learning approach called Materials Genome Integration System Phase and Property Analysis (MIPHA); they use neural networks to design microstructures with desired mechanical properties; does not complete any experimental validation}
