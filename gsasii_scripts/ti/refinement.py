...
gpx = G2sc.G2Project(filename='test.gpx')
...
datadir = "~/git/gsasii_scripts/ti/datadir/"
workdir = "~/git/gsasii_scripts/ti/datadir/"
...
hist1=gpx.add_powder_histogram(os.path.join(datadir,"ti.fxye"),os.path.join(datadir,"ti.prm"))

#Now let's add a phase from a .cif file to our project
phase0 = gpx.add_phase(os.path.join(datadir,"alpha.cif"),phasename="alpha",histograms=[hist1])
