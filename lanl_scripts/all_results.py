...
# Plotting the lattice parameters
    plt.plot(alpha_a_index[5:len(alpha_a_index)],plot_alpha_a[5:len(alpha_a_index)],'r*',alpha_c_index[5:len(alpha_a_index)],plot_alpha_c[5:len(alpha_a_index)],'c+',beta_a_index[5:len(alpha_a_index)],plot_beta_a[5:len(alpha_a_index)],'b.')
    plt.xlabel('Time (seconds)')
    ...
    plt.plot(alpha_a_index[5:len(alpha_a_index)],plot_alpha_c[5:len(alpha_a_index)]/plot_alpha_a[5:len(alpha_a_index)],'r*')
    plt.xlabel('Time (seconds)')
    plt.ylabel('c//a')
    plt.legend('alpha')
...
#The values in beta_a and alpha_a are lattice parameters, adjusted for hydrostatic strains
    ...
    alpha_a_strain = 100* (plot_alpha_a - 2.95111)/(2.95111)
    alpha_c_strain = 100* (plot_alpha_c- 4.68433)/(4.68433)
    beta_strain = 100* (plot_beta_a - 3.252042)/(3.252042)

    plt.plot(alpha_a_index[5:len(alpha_a_index)],alpha_a_strain[5:len(alpha_a_index)],'r*',alpha_c_index[5:len(alpha_a_index)],alpha_c_strain[5:len(alpha_a_index)],'c+',beta_a_index[5:len(alpha_a_index)],beta_strain[5:len(alpha_a_index)],'b.')
    plt.xlabel('Time (seconds)')
