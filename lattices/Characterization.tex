...
\begin{figure}[b]
	\includegraphics[width=1\linewidth]{figures/build_direction}
...
\begin{figure}[b]
	\includegraphics[width=1\linewidth]{figures/crosshead_displacement}
...
%
\begin{figure}
	\includegraphics[width=1\linewidth]{figures/grayscale_microstructure}
...
\begin{figure}
	\includegraphics[width=1\linewidth]{figures/location_explanation}
...
\begin{figure*}[t]
	\includegraphics[width=01\linewidth]{figures/voids.png}
...
\begin{figure}[b]
	\begin{subfigure}{1\linewidth}
		\includegraphics[width=1\linewidth]{figures/001PF_Ti5553}
		\caption{Pole figure of the (001) plane normal in a bulk (node) part of the specimen.}
		\label{P3}
	\end{subfigure}
	%
	\begin{subfigure}{1\linewidth}
		\includegraphics[width=1\linewidth]{figures/P3_001PF_Ti5553}
...
\begin{figure*}
	\includegraphics[width=1\linewidth]{figures/DIC_e11}
...
\end{figure*}
\begin{figure*}
	\includegraphics[width=1\linewidth]{figures/DIC_e22}
